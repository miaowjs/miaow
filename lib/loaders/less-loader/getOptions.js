...
const createUrlResolvePlugin = require('./createUrlResolvePlugin');
...
function getOptions(loaderContext) {
  ...
  // 增加 url 引用的处理
  const urlResolvePlugin = createUrlResolvePlugin(loaderContext);
  options.plugins.push(urlResolvePlugin);
