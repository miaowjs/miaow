...
Module.prototype.createModule = function (relativePath, contents, cb) {
  ...
  var srcPath = path.relative(this.cwd, srcAbsPath);
...
Object.defineProperty(Module.prototype, 'url', {
  get: function () {
    ...
    if (domain) {
      return url.resolve(domain, this.destPathWithHash.split(path.sep).join('/'));
    } else {
      return null;
    }
  }
...
Object.defineProperty(Module.prototype, 'urlWithoutHash', {
  get: function () {
    ...
    if (domain) {
      return url.resolve(domain, this.destPath.split(path.sep).join('/'));
    } else {
      return null;
    }
  }
